...
volatile PPCWGPipe __GXWGFifo : GXFIFO_ADDR;

#define GX_WRITE_U8(ub)     \
    __GXWGFifo.u8 = (u8)(ub)

#define GX_WRITE_U16(us)   \
   __GXWGFifo.u16 = (u16)(us)

#define GX_WRITE_U32(ui)   \
   __GXWGFifo.u32 = (u32)(ui)

#define GX_WRITE_F32(f)     \
   __GXWGFifo.f32 = (f32)(f);
...
struct __GXData_struct {
    ...
    GXTexRegionCallback texRegionCallback; // offset 0x4C8, size 0x4
    GXTlutRegionCallback tlutRegionCallback; // offset 0x4CC, size 0x4
