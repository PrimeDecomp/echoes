...
public:
  CParticleGenInfoGeneric(const SObjectTag& part, rstl::ncrc_ptr< CParticleGen > system, int frames,
                          CSegId segment, CVector3f scale, CParticleData::EParentedMode parentMode,
                          int flags, CStateManager* stateMgr, TAreaId areaId, uint lightId,
                          EParticleGenType state);
  // CParticleGenInfo
  ~CParticleGenInfoGeneric() override;
...
CHECK_SIZEOF(CParticleGenInfoGeneric, 0x84)
