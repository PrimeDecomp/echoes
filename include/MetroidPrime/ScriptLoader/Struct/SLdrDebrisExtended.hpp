#ifndef _SLDRDEBRISEXTENDED
#define _SLDRDEBRISEXTENDED
...
void LoadTypedefSLdrDebrisExtended(SLdrDebrisExtended&, CInputStream&);

#endif // _SLDRDEBRISEXTENDED
